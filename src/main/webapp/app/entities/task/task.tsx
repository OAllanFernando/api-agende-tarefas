            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="taskManagerApp.task.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('executionTime')}>
                  <Translate contentKey="taskManagerApp.task.executionTime">Execution Time</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('executionTime')} />
                </th>
                <th className="hand" onClick={sort('durationMin')}>
                  <Translate contentKey="taskManagerApp.task.durationMin">Duration Min</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('durationMin')} />
                </th>
                ...
                <th>
                  <Translate contentKey="taskManagerApp.task.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {taskList.map((task, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{task.executionTime ? <TextFormat type="date" value={task.executionTime} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{task.durationMin}</td>
                  <td>{task.closed ? 'true' : 'false'}</td>
