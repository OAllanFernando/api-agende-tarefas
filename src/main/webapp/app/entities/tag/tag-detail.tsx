    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tagDetailsHeading">
          <Translate contentKey="taskManagerApp.tag.detail.title">Tag</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="taskManagerApp.tag.name">Name</Translate>
            </span>
          </dt>
          <dd>{tagEntity.name}</dd>
          <dt>
            <Translate contentKey="taskManagerApp.tag.user">User</Translate>
          </dt>
          <dd>{tagEntity.user ? tagEntity.user.id : ''}</dd>
        </dl>
